...
def ark_patterns():
    ...
    return [
        ...
        },
        {
            ...
            "job_category": "nurse",
            "employment_variant": "離職中",
            "template_text": "当ステーションではS-QUE訪問看護eラーニングや入社初日からの新任研修など、訪問看護を基礎から学べる環境が整っております。チーム全体でサポートし合いながら取り組める職場です。",
            "feature_variations": [],
        },
        {
            "pattern_type": "G",
            "job_category": "nurse",
            "template_text": "これからのキャリアを検討されているとのこと、当ステーションではS-QUE訪問看護eラーニングや入社初日からの新任研修など、訪問看護を基礎から学べる環境が整っております。",
            "feature_variations": [],
        },
    ]
