...
**1. 求職者の「気になっていること・不安」に寄り添う**

候補者プロフィール（経歴・資格・こだわり条件・自己PR・希望条件）から、この候補者が気にしている可能性・不安に感じている可能性を読み取る。
...
その不安に対し、**会社側の具体的な制度・事実で答える**。推測や一般論で済ませない。会社情報に該当記述がない場合は別の切り口に変える（捏造禁止）。
