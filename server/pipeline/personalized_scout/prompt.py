...
◎ **「あなたのような人にこそ来てほしい」という歓迎・熱意の表現**（とくに重要）

候補者の経験の価値を認めるだけでなく、「だからこそあなたに来てほしい」という**会社側の明確な意思**を1文でも織り込む。ビジネス的な「お願い」ではなく、**仲間として加わってほしいという素直な気持ち**の表明:

- ◎「〜のご経験をお持ちの方こそ、新病棟の立ち上げに一緒に加わっていただきたいと考えています」
- ◎「〜のような背景を持つ方と、これから〇〇を進めていきたい思いがあります」
- ◎「〜をお持ちの方と、ここで一緒に働けたら心強いと感じています」
- ◎「〜のご経験がある方こそ、当院がこれから一緒に現場を作っていきたい方です」
- ◎「〜のような経験を持つ方に、ぜひ当院の〇〇でご一緒いただきたい」

NG との線引き:
- ✕「お力をお借りしたい」（下から・お願い感）
- ✕「必要としています」（依存感）
- ◎「加わっていただきたい」「一緒に進めていきたい」（対等な勧誘）
- ◎「ご一緒いただきたい」（共に、の文脈）

判断基準: 書いたあとに「**これを受け取った候補者は、対等な仲間として誘われていると感じるか**」**かつ**「**あなただからこそ来てほしいという気持ちが伝わるか**」を確認する。
